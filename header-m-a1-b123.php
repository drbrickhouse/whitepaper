      ...
      <div class="row top">
        <div class="col-lg-12">
          ...
          <div class="row header-b">
            ...
            <div class="col-12 col-md-12 col-lg-3 col-lg-push-6 col-xl-3 col-xl-push-6">
              <?php dynamic_sidebar('header-b3') ?>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-lg-pull-3 col-xl-6 col-xl-pull-3">
